      ...
      <div id="sidebar-menu" class="sidebar-menu">
        <ul>
          ...
          <li class="submenu active">
            ...
            <ul>
              <li>
                ...
                >
                  <a href="#" :class="getActiveMenu('/index/dashboard')"
                    >Admin Dashboard</a
                  >
                </router-link>
              </li>
              <li>
                <router-link
                  to="/index/dashboard-1"
                  @click="navigateTo('/index/dashboard-1')"
                >
                  <a href="#" :class="getActiveMenu('/index/dashboard-1')"
                    >Teacher Dashboard</a
                  >
                </router-link>
              </li>
              <li>
                <router-link
                  to="/index/dashboard-2"
                  @click="navigateTo('/index/dashboard-2')"
                >
                  <a href="#" :class="getActiveMenu('/index/dashboard-2')"
                    >Student Dashboard</a
                  >
                </router-link>
              </li>
          ...
          <li class="submenu">
            ...
            <ul>
              <router-link
                to="/index/add-student"
                @click="navigateTo('/index/list-student')"
                :class="getActiveMenu('/index/list-student')"
              >
                Student List
              </router-link>
              ...
              <li>
                <router-link
                  to="/index/add-student"
                  @click="navigateTo('/index/add-student')"
                  :class="getActiveMenu('/index/add-student')"
                >
                  Student Add
                </router-link>
              </li>
